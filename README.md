...
I'm part of a brilliant team of three female engineers [LasChicas.ai](https://laschicas.ai/), and together we're tackling a major challenge in EdTech: building tools that actually work for educators, not just another app that adds noise or misses the mark. Our approach is rooted in deep research, product-oriented goals, and AI-first development methodologies designed to support public school teachers at scale.
